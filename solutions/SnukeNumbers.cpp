...
/*
 ...
 Editorials:
  ...
  - http://drken1215.hatenablog.com/entry/2018/06/24/010600
   - math analysis
  - https://qiita.com/omi_UT/items/4cc6f06b4a867b31206d
   - math analysis
  - http://phyllo-algo.hatenablog.com/entry/2018/06/24/160442
   - editorial way
  - http://naoyat.hatenablog.jp/entry/ARC099
   - experiment
  - http://hamko.hatenadiary.jp/entry/2018/06/23/233924
   - experiment
  - http://par.hateblo.jp/entry/2018/06/24/213218
   - experiment
  - https://babcs2035.hateblo.jp/entry/2018/06/25/213754
   - experiment
  - http://d.hatena.ne.jp/merom686/20180623/1529768672
   - experiment
 ...
 First step is to figure out that x999999 is NOT the only format of snuke number.
 `xy999999` could be snuke number. I should have figure out that by more experiments.
 
 From this fact, next step is finding how to search such numbers in efficient algorithm.
 If it's impossible to search, more greedy idea is necessary.
 As shown in analysis in editorials, it's possible to show how many non-9 digits can be prefixed.
 
 1) editorial video
 
 Showing that f(n) can be computed in O(10*log10(n)).
 
 2) @drken's approach

 Showing that prefix is at most 150.
 
 {p}9..9 cannot be snuke #
 ...
 Summary:
  ...
  - Rough experiment is important
   - 100% valid experiment is sometimes impossible
   - Discard some of obviously invalid cases to save runtime
  - Experiment with some random number to guess important properties as shown in editorial video
  - Rough bound analysis works in algorithm
   - Showing upper-bound/lower-bound is obviously important
   - It does not need to be tight bound because computer can "search" optimal one in loose-bound
